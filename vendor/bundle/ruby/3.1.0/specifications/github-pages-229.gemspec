...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<jekyll>.freeze, ["= 3.9.4"])
    ...
    s.add_runtime_dependency(%q<jekyll-default-layout>.freeze, ["= 0.1.5"])
    ...
    s.add_development_dependency(%q<rubocop-github>.freeze, ["= 0.20.0"])
  else
    s.add_dependency(%q<jekyll>.freeze, ["= 3.9.4"])
    ...
    s.add_dependency(%q<jekyll-commonmark-ghpages>.freeze, ["= 0.4.0"])
    s.add_dependency(%q<liquid>.freeze, ["= 4.0.4"])
    s.add_dependency(%q<rouge>.freeze, ["= 3.30.0"])
    s.add_dependency(%q<github-pages-health-check>.freeze, ["= 1.18.2"])
    s.add_dependency(%q<jekyll-redirect-from>.freeze, ["= 0.16.0"])
    s.add_dependency(%q<jekyll-sitemap>.freeze, ["= 1.4.0"])
    s.add_dependency(%q<jekyll-feed>.freeze, ["= 0.17.0"])
    s.add_dependency(%q<jekyll-gist>.freeze, ["= 1.5.0"])
    s.add_dependency(%q<jekyll-paginate>.freeze, ["= 1.1.0"])
    s.add_dependency(%q<jekyll-coffeescript>.freeze, ["= 1.2.2"])
    s.add_dependency(%q<jekyll-seo-tag>.freeze, ["= 2.8.0"])
    s.add_dependency(%q<jekyll-github-metadata>.freeze, ["= 2.16.1"])
    s.add_dependency(%q<jekyll-avatar>.freeze, ["= 0.8.0"])
    s.add_dependency(%q<jekyll-remote-theme>.freeze, ["= 0.4.3"])
    s.add_dependency(%q<jekyll-include-cache>.freeze, ["= 0.2.1"])
    s.add_dependency(%q<jemoji>.freeze, ["= 0.13.0"])
    s.add_dependency(%q<jekyll-mentions>.freeze, ["= 1.6.0"])
    s.add_dependency(%q<jekyll-relative-links>.freeze, ["= 0.7.0"])
    s.add_dependency(%q<jekyll-optional-front-matter>.freeze, ["= 0.3.2"])
    s.add_dependency(%q<jekyll-readme-index>.freeze, ["= 0.3.0"])
    s.add_dependency(%q<jekyll-default-layout>.freeze, ["= 0.1.5"])
